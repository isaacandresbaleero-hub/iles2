...
class CustomUserAdmin(UserAdmin):
    model = CustomUser
    list_display = ['username', 'email', 'role', 'university_id', 'is_staff', 'is_supervisor']
    list_filter = ['role', 'is_staff', 'is_supervisor']
...
class InternshipPlacementAdmin(admin.ModelAdmin):
    ...
    search_fields = ['student__username', 'company_name', 'accademic_supervisor__username', 'work_supervisor__username']
